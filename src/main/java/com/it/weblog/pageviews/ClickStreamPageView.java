package com.it.weblog.pageviews;


import com.it.weblog.preprocess.WebLogBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		...
		FileInputFormat.setInputPaths(job, new Path("F:\\weblog\\output"));
		FileOutputFormat.setOutputPath(job, new Path("F:\\weblog\\pageviews2"));

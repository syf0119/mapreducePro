package com.it.weblog.visits;

import com.it.weblog.pageviews.PageViewsBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("F:\\weblog\\pageviews2"));
		FileOutputFormat.setOutputPath(job, new Path("F:\\weblog\\visits"));

...
public class PageViewsBean implements Writable {
	...
	public String toString() {
		...
		sb.append("\001").append(this.session);
		sb.append("\001").append(this.timestr);
		sb.append("\001").append(this.step);
		sb.append("\001").append(this.staylong);
		sb.append("\001").append(this.bytes_send);
		sb.append("\001").append(this.referer);
